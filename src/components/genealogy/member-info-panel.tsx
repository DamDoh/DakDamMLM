...
import CurrentPeriodVolume from '@/components/pv-matching/current-period-volume';
...
export default function MemberInfoPanel() {
  ...
  // REMOVED: Auto-trigger daily match on component mount
  // This was causing repeated matching on every page refresh/navigation
  // Daily match should only be triggered manually by user action or when new PV is added
          ...
          <CollapsibleContent>
            <div className="px-4 pb-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                  ...
                  {/* Right Column: Current Period Volume */}
                  <div className="flex flex-col justify-between h-full">
                      <CurrentPeriodVolume userId={rootMember.id} />
                  </div>
              </div>
            </div>
          </CollapsibleContent>
