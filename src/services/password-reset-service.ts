...
export class PasswordResetService {
  ...
  static async getTokenStatistics(
    ...
    // If filtering by company, get user IDs first since there's no relation
    ...
    const [total, active, used, expired] = await Promise.all([
      prisma.passwordResetToken.count({ where: baseWhere }),
...
/**
 * Exported function for password reset
 */
