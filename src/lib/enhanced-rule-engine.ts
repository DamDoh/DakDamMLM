...
export class EnhancedRuleEngine {
  ...
  private evaluateEnhancedFormula(
    ...
    try {
      ...
      const limitedMath: any = create(all);
      // Disable potentially dangerous functions explicitly
      delete limitedMath.import;
      delete limitedMath.createUnit;
      delete limitedMath.evaluate;
      delete limitedMath.parse;
      delete limitedMath.simplify;
