                    ...
                    {cartItems.length > 0 ? (
                      cartItems.map((item) => {
                        ...
                        <TableRow key={item.product.id}>
                          ...
                          <TableCell className="text-center">
                              <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-destructive" onClick={() => removeFromCart(item.product.id)} icon={Trash2}>
