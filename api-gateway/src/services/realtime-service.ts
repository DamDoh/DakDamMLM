...
class RealtimeService {
  ...
  async sendToUser(userId: string, event: RealtimeEvent): Promise<void> {
    ...
    try {
      ...
      logger.error('Failed to send real-time event:', { error: error instanceof Error ? error.message : String(error) });
    }
  }
  ...
  async sendToCompany(companyId: string, event: RealtimeEvent): Promise<void> {
    ...
    try {
      ...
      logger.error('Failed to send company event:', { error: error instanceof Error ? error.message : String(error) });
    }
  }
  ...
  async sendSystemAnnouncement(event: Omit<RealtimeEvent, 'userId'>): Promise<void> {
    ...
    try {
      ...
      logger.error('Failed to send system announcement:', { error: error instanceof Error ? error.message : String(error) });
    }
  }
  ...
  private async logRealtimeEvent(event: RealtimeEvent): Promise<void> {
    try {
      ...
      logger.error('Failed to log real-time event:', { error: error instanceof Error ? error.message : String(error) });
    }
  }
  ...
  async broadcastLeaderboardUpdate(companyId: string, leaderboardData: any): Promise<void> {
    ...
    try {
      ...
      logger.error('Failed to broadcast leaderboard update:', { error: error instanceof Error ? error.message : String(error) });
    }
  }
