...
exports.recordPerformanceMetric = exports.recordBonusAchieved = exports.recordPayoutProcessed = exports.recordCommissionAmount = exports.recordCommissionPaid = exports.recordCommissionCalculated = exports.metricsService = void 0;
...
const recordPerformanceMetric = (name, value, labels) => exports.metricsService.observeRequest(labels?.method || 'unknown', labels?.path || 'unknown', parseInt(labels?.statusCode || '200'), value / 1000);
