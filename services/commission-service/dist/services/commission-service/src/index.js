...
const commissionRoutes_1 = require("./routes/commissionRoutes");
...
app.use((req, res, next) => {
    ...
    res.on('finish', () => {
        ...
        (0, metrics_1.recordPerformanceMetric)('http_request', duration, {
            method: req.method,
            path: req.path,
...
// API routes
app.use('/api/commissions', commissionRoutes_1.commissionRoutes);
// Metrics endpoint for Prometheus
app.get('/metrics', async (req, res) => {
    try {
        const metrics = await metrics_2.metricsService.getMetrics();
...
const server = app.listen(PORT, async () => {
    logger_1.logger.info('Commission service started', {
        port: PORT,
