export type Rank = 'Member' | 'Bronze' | 'Silver' | 'Gold' | 'Diamond' | 'Blue Diamond' | 'STAR' | 'Elite' | 'Supervisor' | 'Manager' | 'Director' | 'President' | 'Chairman' | 'Black Diamond' | 'Emerald' | 'Blue Emerald' | 'Super Diamond' | 'Half STAR' | 'Crown' | 'Double Diamond' | 'Expired';
export declare const ranks: Rank[];
export type StockistLevel = 'District' | 'Provincial' | 'Regional' | 'Commune';
export declare const stockistLevels: StockistLevel[];
export type AccountType = 'Customer' | 'Distributor';
export declare const accountTypes: readonly ["Customer", "Distributor"];
