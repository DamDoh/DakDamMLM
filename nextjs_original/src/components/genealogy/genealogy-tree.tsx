...
export default function GenealogyTree({ node, onNodeClick, allMembers, onAddMember, onEditMember, isLoading }: GenealogyTreeProps) {
  ...
  const renderChild = (childId: string | null, position: 'left' | 'right') => {
    ...
    if (childNode) {
      return <GenealogyTree node={childNode} onNodeClick={onNodeClick} allMembers={allMembers} onAddMember={onAddMember} onEditMember={onEditMember} isLoading={false} />;
    }
    ...
    if (childId) {
      ...
      return <MemberNode member={member} onNodeClick={onNodeClick} onEditClick={onEditMember}/>;
    }
  ...
  return (
    <div className="tree-container">
      <div className="tree">
        <ul>
          <li>
            <MemberNode member={node} onNodeClick={onNodeClick} onEditClick={onEditMember}/>
            <ul>
              <li>
